...
{
	ENTITYREG(SceneEntity, CutSceneWTF, "Overkill/CutScene", "CutSceneWTF")

	META_DATA_DESC(CutSceneWTF)
		BASE_SCENE_ENTITY_PROP(CutSceneWTF)

	META_DATA_DESC_END()

	eastl::string CutSceneWTF::dialogTexts[] =
	{
		"WTF_Dialog1",		
		"WTF_Dialog2",
		"WTF_Dialog3",		
	...
	void CutSceneWTF::Init()
	{
		ScriptEntity2D::Init();

		Tasks(true)->AddTask(10, this, (Object::Delegate)&CutSceneWTF::Draw);
	}

	void CutSceneWTF::Play()
	{
		ScriptEntity2D::Play();
	...
	void CutSceneWTF::SetNextDialog(SpriteEntity* dialog)
	{
		curDialog++;
	...
	void CutSceneWTF::ShowDialogText(float dt)
	{
	...
	void CutSceneWTF::InitializeStars(Node2D* root)
	{
		starBrights.clear();
	...
	void CutSceneWTF::UpdateStarBrights(float dt)
	{
	...
	{		
		...
		if (curScene == 6)
		{
			WorldManager::instance->SetNextLevel("Level_03", true);
	...
	void CutSceneWTF::Draw(float dt)
	{
